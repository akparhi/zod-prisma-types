...
<br />
<p align="center">
  <a href="https://github.com/akparhi/zod-prisma-types">
    <img src="https://raw.githubusercontent.com/akparhi/zod-prisma-types/main/images/zod-prisma-types.svg" alt="Logo" width="120" height="120">
  </a>
  <h3 align="center">Prisma Autozod</h3>
  <p align="center">
    Prisma generator to auto generate zod schemas from Prisma models.
    <br />
    <a href="https://github.com/akparhi/zod-prisma-types"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/akparhi/zod-prisma-types/blob/main/src/test/functional">View Demo</a>
    ·
    <a href="https://github.com/akparhi/zod-prisma-types/issues">Report Bug</a>
    ·
  </p>
</p>
...
1.  Add zod-prisma-types as a dev dependency

    ```sh
    yarn add zod-prisma-types
    ```

2.  Add the zod-prisma-types generator to your schema.prisma
...
zod-prisma-types enables you to reuse these by importing them via a config options. For example:
...
a value of null stored in the JSON. In accordance with this zod-prisma-types will default to disallowing null values, even if your JSON field is optional.
...
_For examples, please refer to the [Examples Directory](https://github.com/akparhi/zod-prisma-types/blob/main/examples) or the [Functional Tests](https://github.com/akparhi/zod-prisma-types/blob/main/src/test/functional)_

<!-- ROADMAP -->

## Roadmap

See the [open issues](https://github.com/akparhi/zod-prisma-types/issues) for a list of proposed features (and known issues).
...
Project Link: [https://github.com/akparhi/zod-prisma-types](https://github.com/akparhi/zod-prisma-types)
...
[forks-url]: https://github.com/akparhi/zod-prisma-types/network/members
[stars-shield]: https://img.shields.io/github/stars/akparhi/zod-prisma-types.svg?style=for-the-badge
[stars-url]: https://github.com/akparhi/zod-prisma-types/stargazers
[issues-shield]: https://img.shields.io/github/issues/akparhi/zod-prisma-types.svg?style=for-the-badge
[issues-url]: https://github.com/akparhi/zod-prisma-types/issues
[license-shield]: https://img.shields.io/github/license/akparhi/zod-prisma-types.svg?style=for-the-badge
[license-url]: https://github.com/akparhi/zod-prisma-types/blob/main/LICENSE
